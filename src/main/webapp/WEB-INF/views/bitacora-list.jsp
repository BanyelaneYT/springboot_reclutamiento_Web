...
<div class="container-fluid mt-5">
    <div class="row justify-content-center">
        <div class="col-md-11">
            <div class="main-card">
                <h2 class="section-title">Administración de Bitácora</h2>
                        ...
                        <tbody>
                            <c:forEach var="item" items="${listaBitacora}">
                                <tr>
                                    ...
                                    <td>
                                        <c:choose>
                                            <c:when test="${not empty item.reclutaEstado}">
                                                <span class="badge-muted">${item.reclutaEstado}</span>
                                            </c:when>
                                            <c:otherwise>
                                                <span class="text-muted">-</span>
                                            </c:otherwise>
                            ...
                            <c:if test="${empty listaBitacora}">
                                <tr>
                                    <td colspan="8" class="text-center py-4 text-muted" style="border-bottom: 1px solid #2d3243;">
